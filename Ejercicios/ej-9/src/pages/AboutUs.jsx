      ...
      <div className="container min-vh-100 m-0">
        <div className="text-white">
          ...
          <p>
            ...
            cine y televisión. Nuestro equipo está comprometido con la
            excelencia y trabaja arduamente para garantizar que nuestros
            usuarios disfruten de una experiencia de transmisión sin
            interrupciones y de la más alta calidad.
          </p>
        </div>
